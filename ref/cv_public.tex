...
\begin{document}
	...
	\begin{header}
		...
		\AND%
		\kern 0.25 cm%
		\mbox{\hrefWithoutArrow{https://wooyongp.github.io/}{\color{black}{\footnotesize\faLink}\hspace*{0.13cm}Personal Website}}%
		\kern 0.25 cm%
		\AND%
		\kern 0.25 cm%
...
Causal Inference and Applied Microeconomics
	...
	\begin{onecolentry}
[1] \textbf{``Evaluating the Impact of South Korea’s SME Support Policies Using the Economic Shock of Covid-19''} \\(with Seung Hoon Lee)
	\end{onecolentry}
...
\item Presented on following topics: \href{https://wooyongp.github.io/ref/Cluster_SE.html}{``Cluster Robust Standard Errors}", \href{https://www.dropbox.com/scl/fi/rrg7puid9k5btqk6cp7n4/sdid1_public.pdf?rlkey=pti5il9zfrzz0xkb4snbbfxa5&e=1&dl=0}{``Staggered Differences-in-Differences"}, 
\href{https://wooyongp.github.io/git-intro/Slides.html\#/title-slide}{``Introduction to Git/Github for Economic Research}, ``Machine Learning Applications in Applied Microeconomics"
		\end{highlights}
	\end{onecolentry}
...
\vspace{12pt}
	...
	\begin{onecolentry}
		\textbf{Software:} R, Python, SQL,  \LaTeX, Git/GitHub, Quarto
	\end{onecolentry}
