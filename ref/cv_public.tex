...
\item Presented on the following topics: \href{https://wooyongp.github.io/ref/Cluster_SE.html}{``Cluster Robust Standard Errors}", \href{https://www.dropbox.com/scl/fi/rrg7puid9k5btqk6cp7n4/sdid1_public.pdf?rlkey=pti5il9zfrzz0xkb4snbbfxa5&e=1&dl=0}{``Staggered Differences-in-Differences"}, 
...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}p{1cm}|>{\centering\arraybackslash}p{7
	...
	&&Coding for Economics(1)&A\\ 
	
	
	\hline  

\end{tabularx}
\noindent $^*$Graduate Courses taken at Yonsei\\
