...
\href{https://wyeconomics.github.io/git-intro/Slides.html\#/title-slide}{``Introduction to Git/Github for Economic Research}, ``Machine Learning Applications in Applied Microeconomics"
	...
	\section{Fellowships and Grants}
		...
		\textit{Full Tuition for the Masters Degree Graduate Program, Waived due to the predoctoral fellowship at Stanford GSB}
	\end{twocolentry}
...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}p{1cm}|>{\centering\arraybackslash}p{7
	...
	&&Industrial Organization&A+\\ \hline
			&&Econometrics (2)&A\\ \hline
&&Game Theory and its Applications&A\\ 
